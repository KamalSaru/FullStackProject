...
public class AdminController {
    ...
    //Deleting details using the ID--------------------------------
    @DeleteMapping("/{adminID}")
    public ResponseEntity<String>deleteAdminLoginByID(@PathVariable("adminID") Long adminID){
        adminService.deleteAdminLoginByID(adminID);
        return ResponseEntity.ok("Admin details is successfully deleted.");
    }
}
